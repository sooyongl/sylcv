...
\cventry{Northwest Evaluation Association (NWEA)}{maat package development project}{Graduate Research Assistant}{2019/9-2020/5}{\begin{cvitems}\item Development of MAAT package for Computerized Adaptive Testing for Northwest Evaluation Association (NWEA) \end{cvitems}} \end{cventries}
