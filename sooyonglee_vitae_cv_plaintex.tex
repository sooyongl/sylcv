...
\begin{cventries} \cventry{IES grant}{FLPS project}{Post-doc}{2023/9-present}{\begin{cvitems}\item Development of FLPS package for Fully-latent Principal Stratification \end{cvitems}}
...
\textbf{Sooyong Lee}, Adam Sales (2023-04-13). \emph{Bayesian and
...
\cvsoftware{}{Embeded Standard Setting}{Shiny application}{2021}{\begin{cvitems}\item \url{https://sooyonglee.shinyapps.io/ESS_test/}  \end{cvitems}} \end{cvsoftwares}
