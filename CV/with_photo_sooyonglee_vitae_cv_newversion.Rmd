...
\begin{flushleft}
저는 교육통계 및 측정·평가 방법론을 연구하며, 대규모 교육 데이터를 최신 연구방법으로 분석하고 그 결과가 교육 현장과 정책에 실질적으로 연결되는 데 관심을 두고 있습니다.

현재는 WIDA에서 K-12 학생을 대상으로 한 대규모 언어 평가 데이터를 기반으로 척도화·타당화·측정 동일성 분석을 수행하고 있습니다. 최근에는 AI 기반 자동 채점, 기계학습 기반 부정행위 탐지, AI 생성 응답의 젠더 편향 탐지 등 데이터과학과 교육 측정이 교차하는 새로운 연구 영역으로 관심을 넓히고 있습니다. 이러한 연구들은 방법론적 엄밀성을 유지하면서도 교육 공정성과 평가 신뢰성이라는 사회적 문제에 직접 기여한다는 점에서 의미가 있습니다.

아울러 성장 마인드셋과 학업 감정의 종단적 패턴, 청소년의 수학 자기효능감 변화 등 학생 발달과 교육 효과에 관한 연구를 통해, 방법론이 교육 정책과 현장 실천으로 이어질 수 있음을 보여주고자 합니다. 미국에서 쌓은 학문적 훈련과 대규모 평가 실무 경험을 바탕으로, 한국 교육학 및 AI를 비롯한 사회과학 관련 분야에서 세계적 수준의 연구자들과 협력·공동 연구를 이어가며 교육 현장의 실질적 변화에 기여하고 싶습니다.
...
\begin{flushleft} \textbf{In Preparation (05/2026)} \end{flushleft}
...
\begin{flushleft} \textbf{Under Review (05/2026)} \end{flushleft}
