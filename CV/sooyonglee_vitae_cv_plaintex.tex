...
\cveducation{M.A., Major in Educational Statistics and Measurement}{Korea University}{Seoul, Republic of Korea}{2014-2017}{\begin{cvitems}\item Thesis: Exploration of LCA conditions in Latent Class with Low Proportion. Advisor: Sehee Hong \end{cvitems}} \end{cveducations}
...
\hangindent=2em \hangafter=1 Kei Bishop, Hacer Karamese, \textbf{Sooyong
...
\hangindent=2em \hangafter=1 Syed Abdul Hadi, Kei Bishop, Hacer
...
\begin{cventries} \cventry{}{WIDA}{Psychometrician}{2024/4-present}{\begin{cvitems}\item Psychometrics for K-12 students Langauge tests \end{cvitems}}

\cventry{Institute of Educational Sciences (IES) grant}{FLPS project}{Post-doc Fellow}{2023/9-2024/3}{\begin{cvitems}\item Development of `flps` package for Fully-latent Principal Stratification \end{cvitems}}

\cventry{Institute of Educational Sciences (IES) grant}{FLPS project}{Research Assistant}{2021/9-2023/8}{\begin{cvitems}\item Development of `flps` package for Fully-latent Principal Stratification \end{cvitems}}
...
\cventry{Grant from Northwest Evaluation Association (NWEA)}{`maat` package development project}{Research Assistant}{2019/9-2020/5}{\begin{cvitems}\item Development of MAAT package for Computerized Adaptive Testing for Northwest Evaluation Association (NWEA) \end{cvitems}}

\cventry{}{Survey of COE Full-Time Tenured and Tenure-Track Faculty}{Research Assistant}{2019/9-2019/12}{\begin{cvitems}\item Data analysis for surveys of graduate programs of education at the Univerisity of Texas at Austin \end{cvitems}}

\cventry{President's Award for Global Learning (PAGL)}{President's Award for Global Learning (PAGL)}{Research Assistant}{2019/1-2019/8}{\begin{cvitems}\item Designing a culturally appropriate mobile application to increase mental health literacy and self-care habits among South Korean young adults \end{cvitems}}

\cventry{}{CGS PhD Career Pathways project}{Research Assistant}{2018/9-2019/5}{\begin{cvitems}\item Data analysis for surveys to collect data on the career pathways of past and present STEM and humanities PhD students. \end{cvitems}} \end{cventries}
...
\cvsoftware{}{Embeded Standard Setting}{Shiny application}{2021}{\begin{cvitems}\end{cvitems}} \end{cvsoftwares}
...
\begin{cventries} \cventry{}{Structural Equation Modeling: A Multidisciplinary Journal}{Invited Reviewer}{2024}{\begin{cvitems}\end{cvitems}}

\cventry{}{Qeios}{Invited Reviewer}{2024}{\begin{cvitems}\end{cvitems}}

\cventry{}{International Journal of Intercultural Relations}{Reviewer}{2023/7 - present}{\begin{cvitems}\end{cvitems}} \end{cventries}
