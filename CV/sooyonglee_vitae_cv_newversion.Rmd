...
\begin{flushleft}
I develop statistical and measurement models to analyze educational data and apply them to practical problems in education. My research focuses on methods that help us better understand student development, differences across groups, and factors that shape assessment outcomes.

At WIDA, I work with large-scale K–12 language assessment data on scaling, validation, and measurement invariance. I also use statistical models to predict and interpret assessment results. Looking ahead, I aim to extend this methodological work to emerging forms of educational data, including AI-assisted scoring and bias in AI-generated responses.

I have also conducted longitudinal research on student development, including changes in growth mindset, academic emotions, and mathematics self-efficacy. By connecting methodological research with applied educational studies and large-scale assessment practice, I hope to collaborate across disciplines and produce evidence that informs educational practice and policy.
\end{flushleft}
...
entries <- readGoogleSheets("Teaching") %>%
  ...
  dplyr::mutate(
    out = talk_entry(Year, Position, Name, note, Desc, link, link0)
  ) %>%
  dplyr::pull(out)
